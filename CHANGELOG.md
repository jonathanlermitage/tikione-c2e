...
* affiche le texte des articles sur plusieurs colonnes (comme le sommaire) pour améliorer le confort de lecture. Peut être désactivé avec le paramètre `-nocolumn`.
