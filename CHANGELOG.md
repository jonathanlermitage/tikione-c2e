...
* articles en cours d'intégration. Ce qui est fait : auteur, contenus, spécifications, score, mieux prendre en compte les scores non numériques, améliorer le rendu du titre des articles. A terminer : images, avis, état (des jeux en cours de dev), corriger la détection des contenus de type "encadré" et les contenus "inter-titre" présents plus d'une fois par article.
